<div class="box box-default">
    <div class="box-header with-border">
        <h3 class="box-title">店铺七日热销sku前三名</h3>
        <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool"  onclick="window.location.href='{{url("/admin/statistics/temugoods/senvendayskuhot")}}'">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th style="text-align: center;">七日sku销售数量</th>
                ...
                @if(!empty($salesInfo))
                    @foreach($salesInfo["salesInfo"] as $_goodsId => $_sale)
                        <tr style="width: 300px;">
                            ...
                            <td style="text-align: center;vertical-align: middle;">
                                <b>{{$_sale["last_seven_days_sale_volume"]}}</b>
                            </td>
                            <td style="text-align: center;vertical-align: middle;">
                            ...
                            <td style="text-align: center;vertical-align: middle;">
                                <b>{{$_sale["sales_inventory_num"]+$_sale["unavailable_warehouse_inventory_num"]+$_sale["wait_receive_num"]}}</b>
                            </td>
                        </tr>
                    @endforeach
                @endif
